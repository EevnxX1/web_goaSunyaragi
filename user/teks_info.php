...
$query1 = mysqli_query($db, "SELECT * FROM tbl_user WHERE id_user = '$_SESSION[id_user]'");
$user = $query1 -> fetch_array();

$query = mysqli_query($db, "SELECT * FROM tbl_berita WHERE id_berita = $_GET[idb]");
$berita = $query -> fetch_array();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="page1">
      ...
      <h2 data-aos="fade-down" data-aos-duration="2000"><?= "$berita[judul]" ?></h2>
      <div class="border"></div>
    </div>
    <div class="page2">
      <img src="../assets/<?= "$berita[gambar]" ?>" alt="" width="200px" height="200px" />
      <p>
      <?= "$berita[isi1]" ?>
      </p>
      <p>
